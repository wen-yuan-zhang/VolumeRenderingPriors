...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_dir', type=str, default='../data/deepfashion3d_gt_pc/')
    parser.add_argument('--mesh_dir', type=str, default='../log/deepfashion3d/30/udf_meshes')
    parser.add_argument('--mesh_name', type=str, default='udf_res512_step200000.ply')
    ...
    GT_DIR = os.path.join(args.gt_dir, str(scan))

    base_dir = args.mesh_dir
    mesh_name = args.mesh_name
    mesh_file = os.path.join(base_dir, mesh_name)

    gt_pointcloud = os.path.join(GT_DIR, "%d_pc.ply" % scan)
    ...
    if args.mode == 'mesh':
        ...
        data_mesh = o3d.io.read_triangle_mesh(mesh_file)
        ...
        data_pcd_o3d = o3d.io.read_point_cloud(mesh_file)
    ...
    pparent, stem, ext = get_path_components(mesh_file)
    if args.log is None:
